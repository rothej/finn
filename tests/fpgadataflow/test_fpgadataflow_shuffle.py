...
def construct_onnx_model(
    ...
    with tempfile.NamedTemporaryFile(delete=False, suffix=".onnx") as temp_file:
        ...
        new_model.set_tensor_datatype(new_model.get_global_in(), dt)
        new_model.set_tensor_datatype(new_model.get_global_out(), dt)
...
def test_cppsim_shuffle_layer(cpp_shuffle_param, datatype, simd):
    ...
    in_name = model.get_global_in()
    out_name = model.get_global_out()
