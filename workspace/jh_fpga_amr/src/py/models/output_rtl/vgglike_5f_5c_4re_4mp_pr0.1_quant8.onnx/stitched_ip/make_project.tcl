create_project finn_vivado_stitch_proj /tmp/finn_dev_rothej/vivado_stitch_proj_q9o7hgyn -part xc7z020clg400-1
set_msg_config -id {[BD 41-1753]} -suppress
set_property ip_repo_paths [list $::env(FINN_ROOT)/finn-rtllib/memstream /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_0_2tedinh6 /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_f9abmksj /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_1_egh4fdy3 /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_t1nkwn40 /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_2_67sanjcz /tmp/finn_dev_rothej/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_qyna5kxu /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_3_qmlfesz7 /tmp/finn_dev_rothej/code_gen_ipgen_MVAU_rtl_0_50f1gi0a /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_4_gkxv8qg6 /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_07uxf748 /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_5_4lv4o6ol] [current_project]
update_ip_catalog
create_bd_design "finn_design"
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_0_2tedinh6/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_0_2tedinh6/StreamingFIFO_rtl_0.v
create_bd_cell -type module -reference StreamingFIFO_rtl_0 StreamingFIFO_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_f9abmksj/fmpadding_axi.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_f9abmksj/fmpadding.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_f9abmksj/axi2we.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_f9abmksj/FMPadding_rtl_0.v
create_bd_cell -type module -reference FMPadding_rtl_0 FMPadding_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_1_egh4fdy3/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_1_egh4fdy3/StreamingFIFO_rtl_1.v
create_bd_cell -type module -reference StreamingFIFO_rtl_1 StreamingFIFO_rtl_1
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_t1nkwn40/swg_pkg.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_t1nkwn40/ConvolutionInputGenerator_rtl_0_wrapper.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_t1nkwn40/ConvolutionInputGenerator_rtl_0_impl.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_t1nkwn40/swg_common.sv
create_bd_cell -type module -reference ConvolutionInputGenerator_rtl_0 ConvolutionInputGenerator_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_2_67sanjcz/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_2_67sanjcz/StreamingFIFO_rtl_2.v
create_bd_cell -type module -reference StreamingFIFO_rtl_2 StreamingFIFO_rtl_2
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_qyna5kxu/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_qyna5kxu/dwc.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_qyna5kxu/StreamingDataWidthConverter_rtl_0.v
create_bd_cell -type module -reference StreamingDataWidthConverter_rtl_0 StreamingDataWidthConverter_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_3_qmlfesz7/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_3_qmlfesz7/StreamingFIFO_rtl_3.v
...
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_MVAU_rtl_0_50f1gi0a/MVAU_rtl_0_wrapper.v
...
set_property -dict [list CONFIG.DEPTH {2} CONFIG.WIDTH {768} CONFIG.INIT_FILE {/tmp/finn_dev_rothej/code_gen_ipgen_MVAU_rtl_0_50f1gi0a/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_rtl_0/MVAU_rtl_0_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_4_gkxv8qg6/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_4_gkxv8qg6/StreamingFIFO_rtl_4.v
...
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_07uxf748/axilite_if.v
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_07uxf748/thresholding.sv
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_07uxf748/thresholding_axi.sv
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_07uxf748/Thresholding_rtl_0_axi_wrapper.v
create_bd_cell -type module -reference Thresholding_rtl_0_axi_wrapper Thresholding_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_5_4lv4o6ol/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_5_4lv4o6ol/StreamingFIFO_rtl_5.v
...
validate_bd_design
save_bd_design
make_wrapper -files [get_files /tmp/finn_dev_rothej/vivado_stitch_proj_q9o7hgyn/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/finn_design.bd] -top
add_files -norecurse /tmp/finn_dev_rothej/vivado_stitch_proj_q9o7hgyn/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/hdl/finn_design_wrapper.v
set_property top finn_design_wrapper [current_fileset]
ipx::package_project -root_dir /tmp/finn_dev_rothej/vivado_stitch_proj_q9o7hgyn/ip -vendor xilinx_finn -library finn -taxonomy /UserIP -module finn_design -import_files
...
set fp [open /tmp/finn_dev_rothej/vivado_stitch_proj_q9o7hgyn/all_verilog_srcs.txt w]
