create_project finn_vivado_stitch_proj /tmp/finn_dev_rothej/vivado_stitch_proj_p2cp0qwl -part xc7z020clg400-1
set_msg_config -id {[BD 41-1753]} -suppress
set_property ip_repo_paths [list $::env(FINN_ROOT)/finn-rtllib/memstream /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_0_200ek929 /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_q_igq8d7 /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_1_yn_sho3t /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_w4bi_6p0 /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_2_qfcn3b4h /tmp/finn_dev_rothej/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_z_bzw3y9 /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_3_yphg5te8 /tmp/finn_dev_rothej/code_gen_ipgen_MVAU_rtl_0_kjmwpm9r /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_4_2r9dl4lc /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_uhv4wuqu /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_5_1be7erf1] [current_project]
update_ip_catalog
create_bd_design "finn_design"
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_0_200ek929/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_0_200ek929/StreamingFIFO_rtl_0.v
create_bd_cell -type module -reference StreamingFIFO_rtl_0 StreamingFIFO_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_q_igq8d7/fmpadding_axi.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_q_igq8d7/fmpadding.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_q_igq8d7/axi2we.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_q_igq8d7/FMPadding_rtl_0.v
create_bd_cell -type module -reference FMPadding_rtl_0 FMPadding_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_1_yn_sho3t/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_1_yn_sho3t/StreamingFIFO_rtl_1.v
create_bd_cell -type module -reference StreamingFIFO_rtl_1 StreamingFIFO_rtl_1
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_w4bi_6p0/swg_pkg.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_w4bi_6p0/ConvolutionInputGenerator_rtl_0_wrapper.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_w4bi_6p0/ConvolutionInputGenerator_rtl_0_impl.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_w4bi_6p0/swg_common.sv
create_bd_cell -type module -reference ConvolutionInputGenerator_rtl_0 ConvolutionInputGenerator_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_2_qfcn3b4h/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_2_qfcn3b4h/StreamingFIFO_rtl_2.v
create_bd_cell -type module -reference StreamingFIFO_rtl_2 StreamingFIFO_rtl_2
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_z_bzw3y9/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_z_bzw3y9/dwc.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_z_bzw3y9/StreamingDataWidthConverter_rtl_0.v
create_bd_cell -type module -reference StreamingDataWidthConverter_rtl_0 StreamingDataWidthConverter_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_3_yphg5te8/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_3_yphg5te8/StreamingFIFO_rtl_3.v
...
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_MVAU_rtl_0_kjmwpm9r/MVAU_rtl_0_wrapper.v
...
set_property -dict [list CONFIG.DEPTH {2} CONFIG.WIDTH {384} CONFIG.INIT_FILE {/tmp/finn_dev_rothej/code_gen_ipgen_MVAU_rtl_0_kjmwpm9r/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_rtl_0/MVAU_rtl_0_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_4_2r9dl4lc/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_4_2r9dl4lc/StreamingFIFO_rtl_4.v
...
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_uhv4wuqu/axilite_if.v
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_uhv4wuqu/thresholding.sv
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_uhv4wuqu/thresholding_axi.sv
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_uhv4wuqu/Thresholding_rtl_0_axi_wrapper.v
create_bd_cell -type module -reference Thresholding_rtl_0_axi_wrapper Thresholding_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_5_1be7erf1/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_5_1be7erf1/StreamingFIFO_rtl_5.v
...
validate_bd_design
save_bd_design
make_wrapper -files [get_files /tmp/finn_dev_rothej/vivado_stitch_proj_p2cp0qwl/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/finn_design.bd] -top
add_files -norecurse /tmp/finn_dev_rothej/vivado_stitch_proj_p2cp0qwl/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/hdl/finn_design_wrapper.v
set_property top finn_design_wrapper [current_fileset]
ipx::package_project -root_dir /tmp/finn_dev_rothej/vivado_stitch_proj_p2cp0qwl/ip -vendor xilinx_finn -library finn -taxonomy /UserIP -module finn_design -import_files
...
set fp [open /tmp/finn_dev_rothej/vivado_stitch_proj_p2cp0qwl/all_verilog_srcs.txt w]
