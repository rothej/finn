create_project finn_vivado_stitch_proj /tmp/finn_dev_rothej/vivado_stitch_proj_toiiwyrr -part xc7z020clg400-1
set_msg_config -id {[BD 41-1753]} -suppress
set_property ip_repo_paths [list $::env(FINN_ROOT)/finn-rtllib/memstream /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_0_q3ql858y /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_vj86yziz /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_1_efa9gih_ /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_1_sfdiv2 /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_2_ijsgzz5p /tmp/finn_dev_rothej/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_wn7d_3h_ /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_3_3mnhz3vt /tmp/finn_dev_rothej/code_gen_ipgen_MVAU_rtl_0_tufkm0w4 /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_4__yi_zniz /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_0mhfjocp /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_5_dd0efwv8] [current_project]
update_ip_catalog
create_bd_design "finn_design"
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_0_q3ql858y/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_0_q3ql858y/StreamingFIFO_rtl_0.v
create_bd_cell -type module -reference StreamingFIFO_rtl_0 StreamingFIFO_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_vj86yziz/fmpadding_axi.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_vj86yziz/fmpadding.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_vj86yziz/axi2we.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_FMPadding_rtl_0_vj86yziz/FMPadding_rtl_0.v
create_bd_cell -type module -reference FMPadding_rtl_0 FMPadding_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_1_efa9gih_/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_1_efa9gih_/StreamingFIFO_rtl_1.v
create_bd_cell -type module -reference StreamingFIFO_rtl_1 StreamingFIFO_rtl_1
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_1_sfdiv2/swg_pkg.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_1_sfdiv2/ConvolutionInputGenerator_rtl_0_wrapper.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_1_sfdiv2/ConvolutionInputGenerator_rtl_0_impl.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_1_sfdiv2/swg_common.sv
create_bd_cell -type module -reference ConvolutionInputGenerator_rtl_0 ConvolutionInputGenerator_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_2_ijsgzz5p/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_2_ijsgzz5p/StreamingFIFO_rtl_2.v
create_bd_cell -type module -reference StreamingFIFO_rtl_2 StreamingFIFO_rtl_2
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_wn7d_3h_/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_wn7d_3h_/dwc.sv
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_wn7d_3h_/StreamingDataWidthConverter_rtl_0.v
create_bd_cell -type module -reference StreamingDataWidthConverter_rtl_0 StreamingDataWidthConverter_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_3_3mnhz3vt/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_3_3mnhz3vt/StreamingFIFO_rtl_3.v
...
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_MVAU_rtl_0_tufkm0w4/MVAU_rtl_0_wrapper.v
...
set_property -dict [list CONFIG.DEPTH {2} CONFIG.WIDTH {576} CONFIG.INIT_FILE {/tmp/finn_dev_rothej/code_gen_ipgen_MVAU_rtl_0_tufkm0w4/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_rtl_0/MVAU_rtl_0_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_4__yi_zniz/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_4__yi_zniz/StreamingFIFO_rtl_4.v
...
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_0mhfjocp/axilite_if.v
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_0mhfjocp/thresholding.sv
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_0mhfjocp/thresholding_axi.sv
add_files -copy_to ./ip/verilog/rtl_ops/Thresholding_rtl_0 -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_Thresholding_rtl_0_0mhfjocp/Thresholding_rtl_0_axi_wrapper.v
create_bd_cell -type module -reference Thresholding_rtl_0_axi_wrapper Thresholding_rtl_0
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_5_dd0efwv8/Q_srl.v
add_files -norecurse /tmp/finn_dev_rothej/code_gen_ipgen_StreamingFIFO_rtl_5_dd0efwv8/StreamingFIFO_rtl_5.v
...
validate_bd_design
save_bd_design
make_wrapper -files [get_files /tmp/finn_dev_rothej/vivado_stitch_proj_toiiwyrr/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/finn_design.bd] -top
add_files -norecurse /tmp/finn_dev_rothej/vivado_stitch_proj_toiiwyrr/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/hdl/finn_design_wrapper.v
set_property top finn_design_wrapper [current_fileset]
ipx::package_project -root_dir /tmp/finn_dev_rothej/vivado_stitch_proj_toiiwyrr/ip -vendor xilinx_finn -library finn -taxonomy /UserIP -module finn_design -import_files
...
set fp [open /tmp/finn_dev_rothej/vivado_stitch_proj_toiiwyrr/all_verilog_srcs.txt w]
